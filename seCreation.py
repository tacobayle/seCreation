...
#   print(vsphere_url)
  ...
  os.system('export GOVC_DATACENTER={0}; export GOVC_URL={1}; export GOVC_INSECURE=true; govc library.import CLTest {2}'.format(vcenter['dc'], vsphere_url, ova_path))
  if seg['dhcp'] == True:
    for se in range (1, seg['numberOfSe'] + 1):
      ...
      os.system('export GOVC_DATACENTER={0}; export GOVC_URL={1}; export GOVC_GOVC_DATASTORE={2}; export GOVC_INSECURE=true; govc vm.disk.change -vm {3} -size 40G'.format(vcenter['dc'], vsphere_url, vcenter['datastore'], se_name, seg['disk_per_se']))
